...
/**
 * 按钮滑动自动归位效果
 * 增加了点击 就可以自动切换 ，滑动也可以功能
 * 
 * @author luozheng
 *
 */
public class SwitchButton3 extends View{
	...
	private int downY;
	public SwitchButton3(Context context,AttributeSet attrs){
		super(context,attrs);
		init();
	}
	private void init(){
...
//				left=left>bitmapButton.getWidth()&& left<bitmapBackground.getWidth()?max:0;//点的时候left不会改变，所以不是取left
